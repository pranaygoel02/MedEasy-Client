  ...
  return (
    ...
    <Router>
      ...
      <Routes>
        ...
        <Route path='add' element={<ProtectedRoute Component={AddBlog}/>}/>
        <Route path='edit' element={<ProtectedRoute Component={EditBlog}/>}/>
        <Route path='edit/preview' element={<ProtectedRoute Component={Blog}/>}/>
        <Route path='preview' element={<ProtectedRoute Component={Blog}/>}/>
